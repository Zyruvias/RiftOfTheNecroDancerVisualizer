...
function App() {
  ...
  const vibePowerDataForTrack = getVibePathForTrackAndDifficulty(vibePowerQuery.data, track, difficulty)
  ...
  return (
    ...
    <Group>
      ...
      <TrackDisplay trackData={trackData} beatData={beatData} vibeData={vibePowerDataForTrack}/>
    </>
  )
}
